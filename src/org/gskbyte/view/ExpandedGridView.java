...
/**
 * This class avoids the problem of a GridView which is too small when you use wrap_content.
 * 
 * A typical use-case for this is to have a GridView that can be embedded in a ScrollView
